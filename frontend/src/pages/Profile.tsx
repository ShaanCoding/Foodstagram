      ...
      {profileQuery.isLoading == false && (
        <>
          <div className="flex flex-col justify-center items-center my-5">
            ...
            <span className="mt-3 font-bold">{profileQuery.data?.data.data.name}</span>
            <span className="mt-1 mb-3">@{profileQuery.data?.data.data.username}</span>
            ...
            <p className="mb-3 text-center">{profileQuery.data?.data.data.bio}</p>
          </div>
          {/* top bar end */}
