    ...
    <tr className="">
      ...
      <td colSpan={8}>
        <div className="flex items-center justify-between">
          ...
          <button className="font-semibold py-1 px-2 rounded-sm ml-2 opacity-50 hover:opacity-100 bg-slate-100 whitespace-nowrap text-sm border-[1px] border-light-gray">
            Boost post
          </button>
          <button className="font-semibold py-1 px-2 rounded-sm mr-2 opacity-50 hover:opacity-100 bg-slate-100 whitespace-nowrap text-sm border-[1px] border-light-gray">
            ...
          </button>
        </div>
      </td>
...
export default ManagePostTableRows;
